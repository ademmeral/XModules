...
export class XDate {   // https://github.com/ademmeral/XScript/XModules/XDate.js
  #dict = {
    'Y2': { year: '2-digit' },
    'Y': { year: 'numeric' },
    'M': { month: 'numeric' },
...
const getDate = XDate.moment('Y M2 D wdl h12 m2 s dpl').format(Date.now() - 20000000) // random date
